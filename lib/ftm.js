...
function CreditTransfer(creditTxn) {
     ...
     creditTxn.bankAccount.amount += creditTxn.payment.amount;
        ...
        .then(function (result)  {
            ...
            var paymResponse = result.body.Document.CstmrPmtStsRpt.OrgnlGrpInfAndSts.GrpSts;
            var httpResponse = result.statusCode;
            console.log('HTTP STATUS Response: ',httpResponse);
            console.log('GRPSTS Response: ',paymResponse);
            console.log('**************************************************');

            //
            // Possible Settlment response status are:
            ...
            // RJCT Rejected
            //
            if (paymResponse != 'ACSC') {
                // settlment not completed yet, the transaction the settlement is not committed in Block Chain.
                console.log('Settlment not completed. GrpSts Response: ',paymResponse);
                //alert('Settlment not completed. GrpSts Response: ',paymResponse);
            }
            else
                {
